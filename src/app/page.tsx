...
export default function Home() {
  return <><SiteHeader /><main>
    ...
    <section className="home-contact"><div className="home-contact-symbol home-contact-logo"><Image src="/images/tianye-official-logo.png" alt="添烨控股标志" fill sizes="92px" /></div><div><p className="home-eyebrow">从一次沟通开始</p><h2>您认真经营，<br/>我们认真陪伴</h2><p>无论您正在筹备创业，还是想让企业经营更有条理，欢迎和添烨聊一聊。</p></div><div className="home-contact-action"><a href="tel:17805858733">178 0585 8733</a><span>工作日 9:00 - 18:00</span><Link href="/contact" className="primary">预约专业顾问 <span>→</span></Link></div></section>
  </main><SiteFooter /></>;
}
